...
/**
 * This is the item provider adapter for a {@link stl.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Component_name_feature",
								"_UI_Component_type"),
						StlPackage.Literals.COMPONENT__NAME, true, false, false,
	...
	protected void addCostsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Component_costs_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Component_costs_feature",
								"_UI_Component_type"),
						StlPackage.Literals.COMPONENT__COSTS, true, false, false,
	...
	protected void addConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Component_connector_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Component_connector_feature",
								"_UI_Component_type"),
						StlPackage.Literals.COMPONENT__CONNECTOR, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StlPackage.Literals.COMPONENT__SERVICE);
			childrenFeatures.add(StlPackage.Literals.COMPONENT__SLOT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(StlPackage.Literals.COMPONENT__SERVICE, StlFactory.eINSTANCE.createService()));

		newChildDescriptors
				.add(createChildParameter(StlPackage.Literals.COMPONENT__SLOT, StlFactory.eINSTANCE.createSlot()));
	}
