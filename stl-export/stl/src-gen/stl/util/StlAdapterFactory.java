...
public class StlAdapterFactory extends AdapterFactoryImpl {
	...
	protected StlSwitch<Adapter> modelSwitch = new StlSwitch<Adapter>() {
		...
		@Override
		public Adapter caseProductionStore(ProductionStore object) {
			return createProductionStoreAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link stl.ProductLine <em>Product Line</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link stl.Parameter <em>Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link stl.ProductionStore <em>Production Store</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createProductionStoreAdapter() {
		return null;
	}
