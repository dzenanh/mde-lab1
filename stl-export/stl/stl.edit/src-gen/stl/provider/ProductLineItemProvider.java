...
/**
 * This is the item provider adapter for a {@link stl.ProductLine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductLineItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StlPackage.Literals.PRODUCT_LINE__ITEMTYPE);
			childrenFeatures.add(StlPackage.Literals.PRODUCT_LINE__AREA);
		}
	...
	public String getText(Object object) {
		return getString("_UI_ProductLine_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StlPackage.Literals.PRODUCT_LINE__ITEMTYPE,
				StlFactory.eINSTANCE.createItemType()));

		newChildDescriptors
				.add(createChildParameter(StlPackage.Literals.PRODUCT_LINE__AREA, StlFactory.eINSTANCE.createArea()));
	}
