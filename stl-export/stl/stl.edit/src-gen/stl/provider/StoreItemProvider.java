...
/**
 * This is the item provider adapter for a {@link stl.Store} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StoreItemProvider extends ComponentItemProvider {
	...
	protected void addCapacityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Store_capacity_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Store_capacity_feature", "_UI_Store_type"),
						StlPackage.Literals.STORE__CAPACITY, true, false, false,
	...
	protected void addItemtypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Store_itemtype_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Store_itemtype_feature", "_UI_Store_type"),
						StlPackage.Literals.STORE__ITEMTYPE, true, false, true, null, null, null));
	}
